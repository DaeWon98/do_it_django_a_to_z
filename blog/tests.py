...
class TestView(TestCase):
    def setUp(self):
        self.client = Client()
        self.user_camry = User.objects.create_user(username='camry',
                                                   password='korea2002')
        self.user_toyota = User.objects.create_user(username='toyota',
                                                   password='korea2002')
    ...
    def category_card_test(self, soup) :
        ...
        self.assertIn(f'{self.category_music.name} ({self.category_music.post_set.count()})',
                        categories_card.text)
        self.assertNotIn(f'미분류(1)', categories_card.text)
    ...
    def test_post_list(self):
        ...
        self.assertIn(self.user_camry.username.upper(), main_area.text)
        self.assertIn(self.user_toyota.username.upper(), main_area.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_camry.username.upper(), post_area.text)
